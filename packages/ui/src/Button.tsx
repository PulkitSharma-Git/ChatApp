...
export const Button: React.FC<ButtonProps> = ({ children }) => {
    return <button className="relative inline-flex h-12 w-96 h-96 overflow-hidden rounded-lg p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 ">
    ...
    <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg bg-slate-950 px-3 py-1 text-sm font-medium text-white backdrop-blur-3xl">
      <div className="flex flex-col gap-6 items-center justify-cente">
    {children}
      </div>
    </span>
  </button>
